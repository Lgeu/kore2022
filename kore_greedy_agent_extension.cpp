...
BOOST_PYTHON_MODULE(kore_greedy_agent_extension) {
    Py_Initialize();
    np::initialize();
...
// clang-format off
// clang++ -std=c++17 -Wall -Wextra -O3 --shared -fPIC kore_greedy_agent_extension.cpp -o kore_greedy_agent_extension.so -I/home/user/anaconda3/include/python3.8 /usr/local/lib/libboost_numpy38.a /usr/local/lib/libboost_python38.a -lpython3.8 -L/home/user/anaconda3/lib -march=broadwell -l:libblas.so.3
// clang-format on
